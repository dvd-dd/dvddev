...
export default function NotFound() {
  return (
    <main className="relative flex min-h-screen w-full flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute select-none font-display text-[28vw] font-bold leading-none text-brand/[0.04] md:text-[20vw]"
      >
        404
      </span>
      ...
      <div className="relative z-10 mx-auto max-w-xl">
        ...
        <h1 className="mt-5 font-display text-5xl font-bold leading-[0.95] tracking-tight text-fg-base md:text-6xl">
          Signal lost.
        </h1>

        <p className="mx-auto mt-5 max-w-md font-mono text-sm leading-relaxed text-fg-base/60">
        ...
        <Link
          href="/"
          className="group mt-9 inline-flex items-center gap-2 border border-brand/55 bg-brand/[0.06] px-5 py-3 font-mono text-[11px] uppercase tracking-[0.25em] text-brand transition-all duration-300 hover:border-brand hover:bg-brand/[0.14] hover:text-fg-base"
        >
