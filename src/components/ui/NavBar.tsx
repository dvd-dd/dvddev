      ...
      <div className="mx-auto flex w-full max-w-[1920px] items-center justify-between gap-6 px-6 md:px-12">
        ...
        >
          <motion.span
            ...
            className="block origin-center -translate-x-[16px] translate-y-[6px] -rotate-[12deg] [filter:drop-shadow(0_0_4px_rgba(255,86,10,0.35))_drop-shadow(0_0_10px_rgba(255,86,10,0.18))] transition-[filter] duration-500 group-hover:[filter:drop-shadow(0_0_6px_rgba(255,86,10,0.65))_drop-shadow(0_0_16px_rgba(255,86,10,0.35))]"
          >
            <DvdWordmark
      ...
      {open && (
        ...
        >
          <div className="flex h-[80px] items-center justify-between px-6">
            ...
            >
              <DvdWordmark
                className="h-[64px] w-auto origin-center -translate-x-[16px] translate-y-[6px] -rotate-[12deg] [filter:drop-shadow(0_0_4px_rgba(255,86,10,0.35))_drop-shadow(0_0_10px_rgba(255,86,10,0.18))]"
                thicken
              />
            </a>
            <button
