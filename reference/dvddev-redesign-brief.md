...
| 5 | **How I Work** | 4-step process row. Each step: big mono numeral (01, 02, 03, 04) in brand mint, label, 2-3 sentence description. Steps: **01 Discovery call** → **02 Wireframes + tech plan** → **03 Build in public** → **04 Ship + handoff**. Replaces a "Pricing" section. |
